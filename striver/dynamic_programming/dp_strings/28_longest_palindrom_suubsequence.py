"""
The subsequence should be same forwards and backwards, so if we find the
LCS between the forward string and backward string that is the portion which is common and same as forward and backward
It means that this subsequence is our answer
"""
...
def longest_palindrome_subsequence(string_1: str) -> int:
    other_string = string_1[::-1]
    return longest_common_subsequence_tab(string_1, other_string)
